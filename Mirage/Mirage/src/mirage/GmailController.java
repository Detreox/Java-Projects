...
public class GmailController implements Initializable {
    ...
    @FXML
    private WebView viewGmail;

    @FXML
    void homebuttonGmail(ActionEvent event) throws IOException {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        final WebEngine gm = viewGmail.getEngine();
        gm.load("http://www.gmail.com/");
        gm.setJavaScriptEnabled(true);
